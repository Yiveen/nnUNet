...
class nnUNetTrainer(object):
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            self.network = self.build_network_architecture(
                ...
                stage=self.stage,
                deep_supervision_key=self.deep_supervision_key
            ).to(self.device)
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        return get_network_from_plans(
            ...
            stage=stage, deep_supervision_key=deep_supervision_key)
    ...
    def set_deep_supervision_enabled(self, enabled: bool):
        ...
        mod.decoder.deep_supervision_key = enabled
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        with multiprocessing.get_context("spawn").Pool(default_num_processes) as segmentation_export_pool:
            ...
            for i, k in enumerate(dataset_val.keys()):#走的是__getitem__
        ...
        if self.local_rank == 0:
            metrics = compute_metrics_on_folder(join(self.preprocessed_dataset_folder_base, 'gt_segmentations'),
                                                ...
                                                self.label_manager.ignore_label, chill=True, configuration_manager=self.configuration_manager, plans_manager=self.plans_manager,num_processes=default_num_processes * dist.get_world_size() if
